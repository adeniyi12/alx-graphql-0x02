  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#A3D5E0] to-[#F4F4F4] text-gray-800">
      ...
      <main className="flex-grow p-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">{results && results.map(({ id, name, air_date, episode }: EpisodeProps, key: number) => <EpisodeCard id={id} name={name} air_date={air_date} episode={episode} key={key} />)}</div>
